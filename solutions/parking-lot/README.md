...
From the `solutions/parking-lot` directory:
...
â€œnearestâ€ global. Selecting from floor 1 first would incorrectly ignore a much
...
That narrative shows reasoningâ€”not merely knowledge of pattern names.
